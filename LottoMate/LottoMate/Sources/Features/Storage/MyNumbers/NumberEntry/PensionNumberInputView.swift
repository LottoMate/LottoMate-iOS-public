...
class BackspacePensionTextField: UITextField {
...
final class PensionNumberInputView: UIView {
    ...
    private let textFields: [BackspacePensionTextField]
    ...
    init() {
        self.textFields = (0..<6).map { index in
            let textField = BackspacePensionTextField()
